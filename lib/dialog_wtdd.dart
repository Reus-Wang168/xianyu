...
class EntrustOrderDialog extends StatefulWidget {
  const EntrustOrderDialog({super.key});
  ...
  @override
  State<EntrustOrderDialog> createState() => _EntrustOrderDialogState();
}

class _EntrustOrderDialogState extends State<EntrustOrderDialog> {
  // 添加状态变量来跟踪复选框的状态
  bool showTradableOnly = false;
  bool showMyDelegationsOnly = false;
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                        ...
                        data: Theme.of(context).copyWith(
                          checkboxTheme: CheckboxThemeData(
                            ...
                            checkColor: WidgetStateProperty.all(
                                const Color(0xFF65574C)),
                          ),
                        ),
                        child: Checkbox(
                          value: showTradableOnly,
                          onChanged: (bool? value) {
                            setState(() {
                              showTradableOnly = value ?? false;
                            });
                          },
                    ...
                    Transform.scale(
                      ...
                      child: Checkbox(
                        value: showMyDelegationsOnly,
                        onChanged: (bool? value) {
                          setState(() {
                            showMyDelegationsOnly = value ?? false;
                          });
                        },
                        checkColor: const Color(0xFF65574C),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(4), // 方形 Checkbox
                        ),
              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: EntrustOrderDialog.orders.length,
                  itemBuilder: (context, index) {
                    var order = EntrustOrderDialog.orders[index];
                    return Container(
